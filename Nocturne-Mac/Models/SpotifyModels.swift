...
/// Mirrors the discriminated-union SpotifyAuthState from src/server/services/spotify-service.ts.
...
/// https://accounts.spotify.com/api/token (device flow + refresh)
...
/// Stored credentials for the linked Spotify account.
